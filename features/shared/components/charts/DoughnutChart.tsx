...
/**
 * Reusable Doughnut Chart Component (Pie chart with inner radius)
 *
 * @param {Object} props
 ...
 * @param {number} props.innerRadius - Inner radius for doughnut effect (default: 60)
 ...
 * @param {React.ReactNode} props.centerContent - Content to display in the center of the doughnut
 */
