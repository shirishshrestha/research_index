...
export async function getPublicAuthors(
  ...
  if (filters?.research_interest) params.append("research_interest", filters.research_interest);
  ...
  if (filters?.i10_index_min) params.append("i10_index_min", filters.i10_index_min.toString());
  if (filters?.i10_index_max) params.append("i10_index_max", filters.i10_index_max.toString());
  if (filters?.min_citations) params.append("min_citations", filters.min_citations.toString());
  if (filters?.max_citations) params.append("max_citations", filters.max_citations.toString());
  if (filters?.min_publications) params.append("min_publications", filters.min_publications.toString());
  if (filters?.max_publications) params.append("max_publications", filters.max_publications.toString());
  if (filters?.has_orcid !== undefined) params.append("has_orcid", filters.has_orcid.toString());
  if (filters?.has_google_scholar !== undefined) params.append("has_google_scholar", filters.has_google_scholar.toString());
