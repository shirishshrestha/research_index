...
export default function AuthorDashboard() {
  ...
  if (
    isError ||
    (!isPending &&
      (!data?.profile?.stats || data.profile.user_type !== "author"))
  ) {
    return (
      <PanelErrorCard
    ...
    <PanelContainer>
      ...
      <div className="mb-8">
        ...
        <p className="mt-2 text-text-gray">
          Welcome back,{" "}
          {(authorProfile && "full_name" in authorProfile
      ...
      {/* Stats Cards */}
      <AuthorStatsCards
        stats={authorProfile?.stats || ({} as any)}
        collaboration_count={
          authorProfile && "collaboration_count" in authorProfile
            ? authorProfile.collaboration_count || 0
            : 0
        }
        pending={isPending}
      />
